...
def initialize_simulation(args):
    ...
    if clean_start:
        ...
        dirs=[PFM['lv1_his_dir'],PFM['lv1_plot_dir'],PFM['lv1_forc_dir'],PFM['lv2_his_dir'],PFM['lv2_plot_dir'],PFM['lv2_forc_dir'],PFM['lv3_his_dir'],PFM['lv3_plot_dir'],PFM['lv3_forc_dir']] 
        ...
        for dd in dirs: # for everything but run dir
            ...
            for f in glob.glob(ddd):
                os.remove(f)        
        for pp in ['lv1_run_dir','lv2_run_dir','lv3_run_dir']:
            for dd in runl:
                ddd = PFM[pp] + dd
                for f in glob.glob(ddd):
                    os.remove(f)
