...
def  make_LV2_dotin_and_exec( pkl_fnm ):
    print(' --- making dot_in and dot_sh --- ')  # + Ldir['date_string'])
    import init_funs as initfuns
    PFM = initfuns.get_model_info(pkl_fnm)   
...
def  make_LV3_dotin_and_exec( pkl_fnm ):
    print(' --- making dot_in and dot_sh --- ')  # + Ldir['date_string'])
