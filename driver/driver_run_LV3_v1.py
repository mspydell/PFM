...
if PFM['lv3_use_restart']==0:
    ...
    cmd_list = ['python','-W','ignore','init_funs.py','restart_setup','LV3']
    os.chdir('../sdpm_py_util')
    ...
    PFM = get_PFM_info()
    print('\nGoing to use the file ' + PFM['lv3_ini_file'] + ' to restart the simulation')
    print('with time index ' + str(PFM['lv3_nrrec']))
    print('\n')
    if PFM['lv3_nrrec'] < 0:
