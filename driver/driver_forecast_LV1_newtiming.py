...
cmd_list = ['python','-W','ignore','ocn_functions.py','cat_hycom_to_onenc',yyyymmdd_hy,yyyymmddhhmm_pfm,t2str]
...
t01 = datetime.now() # for keeping track of timing of the simulation
os.chdir('../sdpm_py_util')
cmd_list = ['python','-W','ignore','ocn_functions.py','hycom_cat_to_pickles',yyyymmdd_hy]
ret1 = subprocess.run(cmd_list)     
