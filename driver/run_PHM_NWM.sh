...
dateZ=$(date '+%Y%m%d')
fstdout=/home/mspydell/models/PFM_root/PFM/log/LVs_phm_nwm.log

in_py="/home/mspydell/models/PFM_root/PFM/sdpm_py_util/PHM_NWM_sim.py"
info_pkl="/scratch/PHM_Simulations/phm_nwm.pkl"
